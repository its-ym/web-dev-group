...
<section>
   ...
   <form action="../includes/login_includes.php" method="post" style="border:1px solid #ccc">
    <div class="allform-container">
      ...
      <input type="password" name="user_hashed_password" placeholder="Password" required>
